...
import img from '../../assets/womaneating.webp'
    ...
    <div className={classes.signUpContainer}>
      <div className={classes.signUpWrapper}>
        ...
        <div className={classes.signUpRightSide}>
          <h2 className={classes.title}>Déconnexion</h2>
          <form onSubmit={handleSignup} className={classes.signUpForm}>
            ...
            <button className={classes.submitBtn}>Déconnexion</button>
            <p>As tu déja un compte? <Link to='/login'>Connexion</Link></p>
          </form>
          {
            error && (
