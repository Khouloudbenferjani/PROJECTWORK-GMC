  ...
  return (
    <div className={classes.container}>
      <div className={classes.wrapper}>
        {filteredFoods?.length !== 0 && <h2 className={classes.title}>The best {foodEndpoint} dans la region</h2>}
        <div className={classes.foods}>
          ...
          )) : <h1 className={classes.noQuantity}>No {foodEndpoint} maintenant</h1>}
        </div>
      </div>
    </div>
  )
