    ...
    <div className={classes.container}>
      <div className={classes.wrapper}>
        <div className={classes.left}>
          ...
          )) : <h1 className={classes.noProducts}>Aucun Produit dans le panier. Go shopping!</h1>}
        </div>
        <div className={classes.right}>
          <div className={classes.totalProductMsg}>Produits Totaux: {products.length}</div>
          <div className={classes.subtotalCheckoutBtns}>
            <span className={classes.subtotal}>SousTotal: TND{totalPrice}</span>
            <span onClick={handleOrder} disabled={products.length === 0} className={classes.orderNowBtn}>Passez votre Commande</span>
          </div>
        </div>
      </div>
    </div>
